...
import { getCvTemplateById } from 'apiSdk/cv-templates';
import { CvTemplateInterface } from 'interfaces/cv-template';
import { RoleTemplateListPage } from 'pages/role-templates';

function CvTemplateViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('cv_template', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/cv-templates/edit/${id}`} passHref legacyBehavior>
                    <Button
